...
- [023 formula-free core prep](023-formula-free-mit-core-prep.md) — dependency split, direct-install migration guidance, and MIT core authorization are prepared; npm publication evidence is still required before any UE Shed consumer upgrade.
